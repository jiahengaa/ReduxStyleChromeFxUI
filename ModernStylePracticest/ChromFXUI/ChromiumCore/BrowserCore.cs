	...
	: this(parentContainer, null, true)
		...
		internal void OnBrowserCreated(CfxOnAfterCreatedEventArgs e)
		{
			...
			OnV8ContextCreated += (that, args) =>
			{
				...
				{
#if XP
					args.Frame.ExecuteJavaScript(ChromFXUI.XP.Properties.Resources.chromefxui_frameGlobal, null, 0);
#else
                    args.Frame.ExecuteJavaScript(ChromFXUI.Properties.Resources.chromefxui_frameGlobal, null, 0);
#endif
				}
			};

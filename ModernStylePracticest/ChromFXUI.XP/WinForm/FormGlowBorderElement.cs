...
namespace ChromeFX.WinForm.ShadowForm
{
	...
	internal class FormGlowBorderElement : IDisposable
	{
		...
		internal FormGlowBorderElement(ShadowFormDockPositon side, IntPtr parent, FormGlowBorderDecorator decorator)
		{
			_side = side;
		...
		//internal event ShadowFormResizeEventHandler MouseDown;
		...
		//	if (MouseDown != null)
		//	{
		//		ShadowFormResizeArgs args = new ShadowFormResizeArgs(_side, mode);
		//		MouseDown(this, args);
		//	}
		//}

...
namespace ChromeFX.WinForm.ShadowForm
{
	...
	internal class ShadowFormElement : IDisposable
	{
		...
		private readonly ShadowFormDecorator _decorator;
		...
		internal ShadowFormElement(ShadowFormDockPositon side, IntPtr parent, ShadowFormDecorator decorator)
		{
			_side = side;
